...
public class AccountServiceTest {
	 ...
	 * 
	 * assertThat(savedAccount.getAccountNumber()).isEqualTo(account.
	 * getAccountNumber());
	 * assertThat(savedAccount.getAccountStatus()).isEqualTo(account.
	 * getAccountStatus());
	 * assertThat(savedAccount.getAvailableBalance()).isEqualTo(account.
	 * getAvailableBalance()); }
	 * 
	 * @Test public void testUpdateAccount() throws AccountNumberNotFoundException {
	 ...
	 * 
	 * assertThat(updatedAccount.getAccountNumber()).isEqualTo(accountInactive.
	 * getAccountNumber());
	 * assertThat(updatedAccount.getAccountStatus()).isEqualTo(accountInactive.
	 * getAccountStatus());
	 * assertThat(updatedAccount.getAvailableBalance()).isEqualTo(accountInactive.
	 * getAvailableBalance()); }
	 * 
	 * @Test public void testUpdateAccountThrowsAccountNumberNotFoundException() {
	 * 
	 * when(accountRepository.findByAccountNumber(account.getAccountNumber())).
	 * thenReturn(null);
	 * 
	 ...
	 * 
	 * assertThat(updatedAccount.getAccountNumber()).isEqualTo(accountDeleted.
	 * getAccountNumber());
	 * assertThat(updatedAccount.getAccountStatus()).isEqualTo(accountDeleted.
	 * getAccountStatus());
	 * 
	 * }
	 * 
	 * @Test public void testDeleteAccountThrowsAccountNumberNotFoundException() {
	 * 
	 * when(accountRepository.findByAccountNumber(account.getAccountNumber())).
	 * thenReturn(null);
	 * 
	 ...
	 * }
	 * 
	 * @Test public void testFetchAccountByAccountNumber() {
	 * 
	 * when(accountRepository.findByAccountNumber(account.getAccountNumber())).
	 * thenReturn(account);
	 * 
	 ...
	 * }
	 * 
	 * @Test public void testFetchAccountByAccountNumberNotExists() {
	 * 
	 * when(accountRepository.findByAccountNumber(account.getAccountNumber())).
	 * thenReturn(null);
	 * 
	 ...
	 * 
	 * 
	 * @Test public void testFetchAccountsByIfscCode() { List<Account> accounts= new
	 * ArrayList<Account>(); accounts.add(account); accounts.add(accountInactive);
	 * 
	 ...
	 * 
	 * @Test public void
	 * testFetchAccountsByIfscCodeThrowsAccountNumberNotFoundException() {
